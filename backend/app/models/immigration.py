...
class ImmigrationProgram(UUIDMixin, TimestampMixin, Base):
    ...
    requirements: Mapped[dict] = mapped_column(jsonb_column(), nullable=False, default=dict)
...
class ImmigrationProfile(UUIDMixin, Base):
    ...
    profile_data: Mapped[dict] = mapped_column(jsonb_column(), nullable=False, default=dict)
